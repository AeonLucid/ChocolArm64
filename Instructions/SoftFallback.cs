...
#region "Sha1"
        ...
        public static Vector128<float> Sha1SchedulePart2(Vector128<float> tw0_3, Vector128<float> w12_15)
        {
            ...
            Vector128<float> t = Sse.Xor(tw0_3, Sse2.ShiftRightLogical128BitLane(w12_15.AsUInt32(), (byte)4).AsSingle());
        ...
        private static void Rol32_160(ref uint y, ref Vector128<float> x)
        {
            ...
            x = Sse2.ShiftLeftLogical128BitLane(x.AsUInt32(), (byte)4).AsSingle();
...
#region "Sha256"
        ...
        private static void Rol32_256(ref Vector128<float> y, ref Vector128<float> x)
        {
            ...
            y = Sse2.ShiftLeftLogical128BitLane(y.AsUInt32(), (byte)4).AsSingle();
            x = Sse2.ShiftLeftLogical128BitLane(x.AsUInt32(), (byte) 4).AsSingle();
